...
princp=[]
try:
    prox= requests.get('https://github.com/shovo135790/SHOVO-PAID/blob/main/Afroveal.txt').text
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;94m✮⃝RꫝKIB𝄟⃝🔵\33[1;96m    ║\033[1;31m 
╠══[Facebook                 • RAKIB ON     ║  \033[1;97m  
╠══[Github                   • \33[1;98mKING RAKIBOPP ║\33[1;97m   
╠══[Whatsapp                 • 018********  ║\33[1;92m 
╠══[TOOLS                    • PAID         ║ \33[1;94m   
╠══[VERSION                  • 1.2          ║\033[1;96m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m """
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/KINGRAKIBOPP/RAKIBOPP/blob/main/RAKIBOPP.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
